...
- Кастомизируемый минималистичный лаунчер игр и программ.
- Единое меню для запуска игр и приложений через ярлыки.
- Автоматическое добавление ярлыков в библиотеку.
- Пользовательские изображения и оформление игровых плиток.
- Собственные папки для удобной организации библиотеки.
- Пользовательские иконки папок.
- Гибкая настройка отображения плиток и количества колонок.
- Быстрое применение изменений через Reload без перезапуска SAO Utils.
